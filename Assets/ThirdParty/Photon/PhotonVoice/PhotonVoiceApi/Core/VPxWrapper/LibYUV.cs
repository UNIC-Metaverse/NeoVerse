...
namespace LibYUV
{
    public class LibYUV
    {
        ...
        public static extern int ConvertFromI420(IntPtr y, int y_stride, IntPtr u, int u_stride, IntPtr v, int v_stride, IntPtr dst_sample, int dst_sample_stride, int width, int height, UInt32 fourcc);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ConvertToI420(IntPtr sample, UIntPtr sample_size, IntPtr dst_y, int dst_stride_y, IntPtr dst_u, int dst_stride_u, IntPtr dst_v, int dst_stride_v, int crop_x, int crop_y, int src_width, int src_height, int crop_width, int crop_height, RotationMode rotation, UInt32 fourcc);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int BGRAToARGB(IntPtr src_rgba, int src_stride_rgba, IntPtr dst_argb, int dst_stride_argb, int width, int height);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ARGBToNV12(IntPtr src_frame, int src_stride_frame, IntPtr dst_y, int dst_stride_y, IntPtr dst_uv, int dst_stride_uv, int width, int height);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int I420ToNV12(IntPtr src_y, int src_stride_y, IntPtr src_u, int src_stride_u, IntPtr src_v, int src_stride_v, IntPtr dst_y, int dst_stride_y, IntPtr dst_uv, int dst_stride_uv, int width, int height);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ARGBToNV21(IntPtr src_frame, int src_stride_frame, IntPtr dst_y, int dst_stride_y, IntPtr dst_uv, int dst_stride_uv, int width, int height);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int I420ToNV21(IntPtr src_y, int src_stride_y, IntPtr src_u, int src_stride_u, IntPtr src_v, int src_stride_v, IntPtr dst_y, int dst_stride_y, IntPtr dst_vu, int dst_stride_vu, int width, int height);

        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int NV21ToARGB(IntPtr src_y, int src_stride_y, IntPtr src_vu, int src_stride_vu, IntPtr dst_argb, int dst_stride_argb, int width, int height);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int NV12ToARGB(IntPtr src_y, int src_stride_y, IntPtr src_vu, int src_stride_vu, IntPtr dst_argb, int dst_stride_argb, int width, int height);
        ...
        public static extern int I420Rotate(
            ...
            RotationMode mode);
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ARGBRotate(
        ...
        [DllImport(lib_name, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern int ARGBCopy(
            IntPtr src_argb, int src_stride_argb,
            IntPtr dst_argb, int dst_stride_argb,
            int src_width, int src_height);
